...
/**
 * To be used to plot a second scale on the graph. The second scale has always to have manual bounds. Use
 * {@link #setMinY(double)} and {@link #setMaxY(double)} to set them. The second scale has it's own array of series.
 *
 * @author jjoe64
 */
public class SecondScale {
	...
	/**
	 * flag whether the y axis bounds are manual. For the current version this is always true.
	 */
	...
	/**
	 * creates the second scale. normally you do not call this contructor. Use
	 * {@link space.under.graphview.GraphView#getSecondScale()} in order to get the instance.
	 */
	...
	/**
	 * add a series to the second scale. Don't add this series also to the GraphView object.
	 *
	 * @param s the series
	 */
