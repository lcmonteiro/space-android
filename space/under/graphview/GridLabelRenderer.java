/**
 * GraphView Copyright (C) 2014 Jonas Gehring
 *
 * This program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public
 * License as published by the Free Software Foundation; either version 2 of the License, with the "Linking Exception",
 * which can be found at the license.txt file in this program.
 *
 * This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied
 * warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.
 *
 * You should have received a copy of the GNU General Public License with the "Linking Exception" along with this
 * program; if not, write to the author Jonas Gehring <g.jjoe64@gmail.com>.
 */
package space.under.graphview;
...
public class GridLabelRenderer {
	...
	public final class Styles {
		...
		/**
		 * the general text size of the axis titles. can be overwritten with #verticalAxisTitleTextSize and
		...
		/**
		 * flag whether the horizontal labels are visible
		 */
		boolean horizontalLabelsVisible;

		/**
		 * flag whether the vertical labels are visible
		 */
	...
	/**
	 * cache of the vertical steps (horizontal lines and vertical labels) Key = Pixel (y) Value = y-value
	 */
	private Map<Integer, Double> mStepsVertical;

	/**
	 * cache of the vertical steps for the second scale, which is on the right side (horizontal lines and vertical
	 * labels) Key = Pixel (y) Value = y-value
	 */
	private Map<Integer, Double> mStepsVerticalSecondScale;

	/**
	 * cache of the horizontal steps (vertical lines and horizontal labels) Key = Pixel (x) Value = x-value
	 */
	...
	/**
	 * the width of the vertical labels of the second scale
	 */
	private Integer mLabelVerticalSecondScaleWidth;

	/**
	 * the height of the vertical labels of the second scale
	 */
	...
	/**
	 * the label formatter, that converts the raw numbers to strings
	 */
	...
	/**
	 * count of the vertical labels, that will be shown at one time.
	 */
	...
	/**
	 * resets the styles. This loads the style from reading the values of the current theme.
	 */
	public void resetStyles() {
		...
		try {
			array = mGraphView.getContext().obtainStyledAttributes(typedValue.data, new int[]{
				android.R.attr.textColorPrimary, android.R.attr.textColorSecondary, android.R.attr.textSize, android.R.attr.horizontalGap});
	...
	/**
	 * @return the alignment of the text of the vertical labels
	 */
	...
	/**
	 * clears the internal cache and forces to redraw the grid and labels. Normally you should always call
	 * {@link GraphView#onDataChanged(boolean, boolean)} which will call this method.
	 *
	 * @param keepLabelsSize true if you don't want to recalculate the size of the labels. It is recommended to use
	 * "true" because this will improve performance and prevent a flickering.
	 * @param keepViewport true if you don't want that the viewport will be recalculated. It is recommended to use
	...
	/**
	 * calculates the vertical steps of the second scale. This will not do any automatically update of the bounds.
	...
	/**
	 * calculates the horizontal steps. This will automatically change the bounds to nice human-readable min/max.
	 *
	 * @return true if it is ready
	 */
	...
	/**
	 * adjusts the grid and labels to match to the data this will automatically change the bounds to nice
	 * human-readable values, except the bounds are manual.
	 */
...
//            ViewCompat.postInvalidateOnAnimation(mGraphView);
			...
			mGraphView.postInvalidateDelayed(10);
			return;
		}
	...
	/**
	 * @return the horizontal axis title height or 0 if there is no title
	 */
	...
	/**
	 * @return the vertical axis title width or 0 if there is no title
	 */
	...
	/**
	 * @return the vertical label width 0 if there are no vertical labels
	 */
	...
	/**
	 * sets a manual and fixed with of the space for the vertical labels. This will prevent GraphView to calculate
	 * the width automatically.
	 *
	 * @param width the width of the space for the vertical labels. Use null to let GraphView automatically
	 * calculate the width.
	 */
	...
	/**
	 * @return the horizontal label height 0 if there are no horizontal labels
	 */
	...
	/**
	 * sets a manual and fixed height of the space for the horizontal labels. This will prevent GraphView to
	 * calculate the height automatically.
	 *
	 * @param height the height of the space for the horizontal labels. Use null to let GraphView automatically
	...
	/**
	 * @param textSize the general text size of the axis titles. can be overwritten with
	 * {@link #setVerticalAxisTitleTextSize(float)} and {@link #setHorizontalAxisTitleTextSize(float)}
	 */
	...
	/**
	 * @param highlightZeroLines flag whether the zero-lines (vertical+ horizontal) shall be highlighted
	 */
	...
	/**
	 * @return the label formatter, that converts the raw numbers to strings
	 */
	...
	/**
	 * @param mLabelFormatter the label formatter, that converts the raw numbers to strings
	 */
	...
	/**
	 * @return the width of the vertical labels of the second scale
	 */
	...
	/**
	 * @return flag whether the horizontal labels are visible
	 */
	...
	/**
	 * @param horizontalTitleVisible flag whether the horizontal labels are visible
	 */
	...
	/**
	 * @return flag whether the vertical labels are visible
	 */
	...
	/**
	 * @param verticalTitleVisible flag whether the vertical labels are visible
	 */
	...
	/**
	 * @return count of the vertical labels, that will be shown at one time.
	 */
	...
	/**
	 * @param mNumVerticalLabels count of the vertical labels, that will be shown at one time.
	 */
	...
	/**
	 * @return count of the horizontal labels, that will be shown at one time.
	 */
	...
	/**
	 * @param mNumHorizontalLabels count of the horizontal labels, that will be shown at one time.
	 */
