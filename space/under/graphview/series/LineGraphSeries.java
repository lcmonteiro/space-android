...
/**
 * Series to plot the data as line. The line can be styled with many options.
 *
 * @author jjoe64
 */
public class LineGraphSeries<E extends DataPointInterface> extends BaseSeries<E> {
	...
	private final class Styles {
		...
		/**
		 * the thickness of the line. This option will be ignored if you are using a custom paint via
		 * {@link #setCustomPaint(android.graphics.Paint)}
		 */
		private int thickness = 5;

		/**
		 * flag whether the area under the line to the bottom of the viewport will be filled with a specific
		 * background color.
		 *
		 * @see #backgroundColor
		 */
	...
	/**
	 * custom paint that can be used. this will ignore the thickness and color styles.
	 */
	...
	/**
	 * flag whether the area under the line to the bottom of the viewport will be filled with a specific background
	 * color.
	 *
	...
	/**
	 * @return the background color for the filling under the line.
	...
	/**
	 * @param backgroundColor the background color for the filling under the line.
	 * @see #setDrawBackground(boolean)
	 */
