...
/**
 * Series that plots the data as points. The points can be different shapes or a complete custom drawing.
 *
 * @author jjoe64
 */
public class PointsGraphSeries<E extends DataPointInterface> extends BaseSeries<E> {
	...
	public static interface CustomShape {
		...
		/**
		 * called when drawing a single data point. use the x and y coordinates to render your drawing at this
		 * point.
		 *
		 * @param canvas canvas to draw on
		 * @param paint internal paint object. this has the correct color. But you can use your own paint.
	...
	/**
	 * choose a predefined shape to render for each data point. You can also render a custom drawing via
	 * {@link space.under.graphview.series.PointsGraphSeries.CustomShape}
	 */
	public enum Shape {
	...
	private final class Styles {
		...
		/**
		 * this is used for the size of the shape that will be drawn. This is useless if you are using a custom
		 * shape.
		 */
		float size;
	...
	/**
	 * This is used for the size of the shape that will be drawn. This is useless if you are using a custom shape.
	 *
	...
	/**
	 * Use a custom handler to render your own drawing for each data point.
	 *
