...
public class LegendRenderer {
	...
	/**
	 * wrapped styles regarding to the legend
	 */
	...
	/**
	 * flag whether legend will be drawn
	 */
	...
	/**
	 * cached legend width this will be filled in the drawing. Can be cleared via {@link #resetStyles()}
	 */
	...
	/**
	 * sets the font size. this will clear the internal legend width cache
	 *
	 ...
	 *
	 * @return the width of the box 0 => auto
	 */
	public int getWidth() {
	 ...
	 * the width of the box exclusive padding
	 *
	 * @param width the width of the box exclusive padding 0 => auto
	 */
	...
	/**
	 * @return background color of the box it is recommended to use semi-transparent color.
	 */
	...
	/**
	 * @param backgroundColor background color of the box it is recommended to use semi-transparent color.
	 */
	...
	/**
	 * @return margin from the edge of the box to the corner of the graphview
	 */
	...
	/**
	 * @param margin margin from the edge of the box to the corner of the graphview
	 */
	...
	/**
	 * Use fixed coordinates to position the legend. This will override the align setting.
	 *
