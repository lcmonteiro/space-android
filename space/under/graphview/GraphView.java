...
import space.under.graphview.series.Series;
...
public class GraphView extends View {
	...
	/**
	 * Class to wrap style options that are general to graphs.
	 *
	 * @author jjoe64
	 */
	private static final class Styles {
		...
		/**
		 * The font size of the title that can be displayed above the graph.
		 *
		...
		/**
		 * The font color of the title that can be displayed above the graph.
		 *
		 * @see GraphView#setTitle(String)
		 */
		int titleColor;
	...
	/**
	 * Helper class to detect tap events on the graph.
	 *
	 * @author jjoe64
	 */
	...
	/**
	 * our series (this does not contain the series that can be displayed on the right side. The right side series
	 * is a special feature of the {@link SecondScale} feature.
	 */
	...
	/**
	 * viewport that holds the current bounds of view.
	 */
	...
	/**
	 * feature to have a second scale e.g. on the right side
	 */
	...
	/**
	 * initialize the internal objects. This method has to be called directly in the constructors.
	 */
	protected void init() {
	...
	/**
	 * Add a new series to the graph. This will automatically redraw the graph.
	 *
	...
	/**
	 * important: do not do modifications on the list object that will be returned. Use
	 * {@link #removeSeries(space.under.graphview.series.Series)} and
	 * {@link #addSeries(space.under.graphview.series.Series)}
	 *
	 * @return all series
	 */
	...
	/**
	 * call this to let the graph redraw and recalculate the viewport. This will be called when a new series was
	 * added or removed and when data was appended via
	 * {@link space.under.graphview.series.BaseSeries#appendData(space.under.graphview.series.DataPointInterface, boolean, int)}
	 * or
	 * {@link space.under.graphview.series.BaseSeries#resetData(space.under.graphview.series.DataPointInterface[])}.
	 *
	...
	/**
	 * Draws the Graphs title that will be shown above the viewport. Will be called by GraphView.
	 *
	 * @param canvas Canvas
	 */
	 ...
	 *
	 * @return the actual size of the title. if there is no title, 0 will be returned.
	 */
	 ...
	 * @see space.under.graphview.Viewport
	 */
	...
	/**
	 * Called by Android system if the size of the view was changed. Will recalculate the viewport and labels.
	 *
	 * @param w
	 * @param h
	 * @param oldw
	...
	/**
	 * @return the space on the left side of the view from the left border to the beginning of the graph viewport.
	 */
	...
	/**
	 * @return the space on the top of the view from the top border to the beginning of the graph viewport.
	 */
	 ...
	 * @see space.under.graphview.LegendRenderer
	 */
	...
	/**
	 * @return the title that will be shown above the graph.
	 */
	...
	/**
	 * Remove a specific series of the graph. This will also re-render the graph, but without recalculating the
	 * viewport and label sizes. If you want this, you have to call {@link #onDataChanged(boolean, boolean)}
	 * manually.
	 *
	 * @param series
	 */
