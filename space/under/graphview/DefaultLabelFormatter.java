...
/**
 * The label formatter that will be used by default. It will use the NumberFormat from Android and sets the maximal
 * fraction digits depending on the range between min and max value of the current viewport.
 *
 * It is recommended to use this label formatter as base class to implement a custom formatter.
 *
 * @author jjoe64
 */
public class DefaultLabelFormatter implements LabelFormatter {
	...
	/**
	 * reference to the viewport of the graph. Will be used to calculate the current range of values.
	 */
