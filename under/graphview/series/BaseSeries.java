 ...
 */
package space.under.graphview.series;
...
/**
 * Basis implementation for series. Used for series that are plotted on a default x/y 2d viewport.
 *
 * Extend this class to implement your own custom graph type.
 *
 * This implementation uses a internal Array to store the data. If you want to implement a custom data provider you may
 * want to implement {@link space.under.graphview.series.Series}.
 *
 * @author jjoe64
 */
public abstract class BaseSeries<E extends DataPointInterface> implements Series<E> {
	...
	/**
	 * stores the used coordinates to find the corresponding data point on a tap
	 *
	 * Key => x/y pixel Value => Plotted Datapoint
	 *
	...
	/**
	 * title for this series that can be displayed in the legend.
	 */
	private String mTitle;

	/**
	 * base color for this series. will be used also in the legend
	 */
	...
	/**
	 * stores the graphviews where this series is used. Can be more than one.
	 */
	...
	/**
	 * get the values for a given x range. if from and until are bigger or equal than all the data, the original
	 * data is returned. If it is only a part of the data, the range is returned plus one datapoint before and after
	 * to get a nice scrolling.
	 *
	...
	/**
	 * set the title of the series. This will be used in the legend.
	 *
	...
	/**
	 * set the color of the series. This will be used in plotting (depends on the series implementation) and is used
	 * in the legend.
	 *
	 * @param mColor
	 */
	...
	/**
	 * clears the data of this series and sets new. will redraw the graph
	 *
	 * @param data the values must be in the correct order! x-value has to be ASC. First the lowest x value and at
	...
	/**
	 *
	 * @param dataPoint values the values must be in the correct order! x-value has to be ASC. First the lowest x
	 * value and at least the highest x value.
	 * @param scrollToEnd true => graphview will scroll to the end (maxX)
	 * @param maxDataPoints if max data count is reached, the oldest data value will be lost to avoid memory leaks
	 */
